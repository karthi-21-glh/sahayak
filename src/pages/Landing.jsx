function Landing({ onStart, language, setLanguage }) {
  ...
  const t = {
    en: {
      ...
      tellCard:
        "Describe your situation naturally by typing or speaking.",
      matchCard:
        "Compare your information with the available scheme dataset.",
      readyCard:
        "Understand potential matches, documents and next steps.",
    ...
    hi: {
      ...
      tellCard:
        "टाइप करके या बोलकर अपनी स्थिति सामान्य तरीके से बताएं।",
      matchCard:
        "आपकी जानकारी की उपलब्ध योजनाओं के डेटासेट से तुलना करें।",
      readyCard:
        "संभावित लाभ, आवश्यक दस्तावेज़ और अगले कदम समझें।",
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#102d68] text-lg font-bold text-white">
              S
            </div>

            <div>
              <h1 className="text-lg font-bold text-[#102d68]">
                SAHAYAK
              </h1>
...
function JourneyStep({ number, title, description }) {
  return (
    <div className="flex gap-4 rounded-2xl border border-slate-100 bg-slate-50 p-4">
      ...
      <div>
        <h4 className="font-bold text-[#102d68]">
          {title}
        </h4>
...
function InfoCard({ number, title, description }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-7 transition hover:-translate-y-1 hover:shadow-lg">
      ...
      <h3 className="mt-6 text-xl font-bold text-[#102d68]">
        {title}
      </h3>
...
function TrustCard({ icon, title }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6">
      ...
      <h3 className="mt-4 font-bold text-[#102d68]">
        {title}
      </h3>
